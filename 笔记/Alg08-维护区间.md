...
|               LG1816. 忠诚<br />LG2068. 统计和               |            线段树裸题，可用于练习 zkw 线段树板子             |
|   LG1471. 方差<br/>LG2894. Hotel<br/>CF527C. Glass Carving   |                        线段树模版变体                        |
...
| LC0295. 数据流的中位数 | 使用平衡树维护kth元素，然后qq 平均值，或者使用一个两个堆来确定中位数 |
